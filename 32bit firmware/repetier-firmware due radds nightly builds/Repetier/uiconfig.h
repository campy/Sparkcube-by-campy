...
void uiInitKeys() {
#if UI_HAS_KEYS!=0
  UI_KEYS_INIT_CLICKENCODER_LOW(33,35); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
...
void uiCheckKeys(int &action) {
 ...
 UI_KEYS_CLICKENCODER_LOW_REV(33,35); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
